...
const Publications = () => {
  return (
    <section id="publications" className="py-20 bg-neutral-50 dark:bg-neutral-800/50">
          ...
          <div className="space-y-8">
            {publications.map((pub) => (
              <a
                key={pub.title}
                href={pub.link}
                className="block bg-white dark:bg-neutral-800 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-200"
              >
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  ...
                  <div className="shrink-0">
                    <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-accent dark:bg-accent-foreground/10 text-accent-foreground">
                      →
                    </span>
                  </div>
                </div>
